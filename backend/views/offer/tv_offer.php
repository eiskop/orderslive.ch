...
//$this->params['breadcrumbs'][] = $this->title;
    ...
    echo '<table class="table" style="font-size:1.3em; width: 100%;">
    		<tr>
    			...
    			<td rowspan="3" style="width: 60%; padding-left: 5%; text-align: right; font-size:0.9em; text-align: center;"><img src="../web/pic/jw_logo_500w.png" ><br>'.date('H:i').' '.date('d.m.Y').' (KW'.date('W').')</td>
    		</tr>
    		<tr>
