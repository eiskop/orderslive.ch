...
date_default_timezone_set('Europe/Zurich');
echo '<h2>Unbestätigte Aufträge - Wirus</h2>';
//
...
WHERE  so.product_group_id = 2 AND confirmation_no LIKE "" and status_id != 3 and status_id != 4 ORDER BY order_received ASC')->queryAll();
